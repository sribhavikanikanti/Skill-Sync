...
public class MentorshipsFragment extends BaseFragment {

    private RecyclerView recyclerView;
    private EventRecyclerViewAdapter adapter;
    private ArrayList<EventModel> eventList = new ArrayList<>();
    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private static final String TAG = "MentorshipsFragment";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_mentorships, container, false);
        ...
        loadCurrentMentorships();

        return view;
    }

    private void loadCurrentMentorships() {
        db.collection("Events")
                .whereEqualTo("navigation", "Mentorships")
                .get()
