...
public class InternshipsFragment extends BaseFragment {

    private RecyclerView recyclerView;
    private EventRecyclerViewAdapter adapter;
    private ArrayList<EventModel> eventList = new ArrayList<>();
    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private static final String TAG = "InternshipsFragment";
    ...
    private void loadCurrentInternships() {
        db.collection("Events")
                .whereEqualTo("navigation", "Internships")
                .get()
