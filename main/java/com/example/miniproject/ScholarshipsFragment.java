...
public class ScholarshipsFragment extends BaseFragment {

    private RecyclerView recyclerView;
    private EventRecyclerViewAdapter adapter;
    private ArrayList<EventModel> eventList = new ArrayList<>();
    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private static final String TAG = "ScholarshipsFragment";
    ...
    private void loadCurrentScholarships() {
        db.collection("Events")
                .whereEqualTo("navigation", "Scholarships")
                .get()
