...
public class HackathonsFragment extends BaseFragment {
    ...
    private static final String TAG = "HackathonsFragment";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_hackathons, container, false);
        ...
        loadCurrentHackathons();

        return view;
    }

    private void loadCurrentHackathons() {
        db.collection("Events")
                .whereEqualTo("navigation", "Hackathons")
                .get()
