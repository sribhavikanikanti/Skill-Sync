...
public class CertificationCoursesFragment extends BaseFragment {

    private RecyclerView recyclerView;
    private EventRecyclerViewAdapter adapter;
    private ArrayList<EventModel> eventList = new ArrayList<>();
    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private static final String TAG = "CertificationCoursesFragment";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_certification_courses, container, false);
        ...
        loadCurrentCertificationCourses();

        return view;
    }

    private void loadCurrentCertificationCourses() {
        db.collection("Events")
                .whereEqualTo("navigation", "Certification Courses")
                .get()
