...
public class StudentMainActivity extends BaseNavigationActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("StudentMainActivity", "Received userRole: " + userRole);
        ...
        if (savedInstanceState == null) {
            ...
            Log.d("StudentMainActivity", "Setting arguments for EventsFragment: " + userRole);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("user_role", userRole);
        Log.d("StudentMainActivity", "Setting arguments for fragment: " + userRole);
        ...
        if (itemId == R.id.nav_hackathons) {
            ...
            Toast.makeText(StudentMainActivity.this, "Logging out...", Toast.LENGTH_SHORT).show();
